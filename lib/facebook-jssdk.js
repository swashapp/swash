/*1549350083,,JIT Construction: v4738566,en_US*/
/**
      ...
      with (this) {
        ...
        __d('ES6DatePrototype', [
          ...
          a = {
            toISOString: function () {
              ...
              return a + '-' + g(this.getUTCMonth() + 1) + '-' + g(this.getUTCDate()) + 'T' + g(this.getUTCHours()) + ':' + g(this.getUTCMinutes()) + ':' + g(this.getUTCSeconds()) + '.' + (this.getUTCMilliseconds() / 1000).toFixed(3).slice(2, 5) + 'Z'
            }
          };
          e.exports = a
        }), null);
        ...
        __d('ES7Object', [
          ...
          a.entries = function (a) {
            ...
            for (var c in a) h.call(a, c) && b.push([c,
            a[c]]);
            g(a, function (c) {
              return b.push([c,
              a[c]])
 ...
 */
                  ...
                  if (b == 'bug-string-char-index') c = 'a'[0] != 'a';
                    ...
                    if (b == 'json-stringify') {
                      ...
                      if (j) {
                        ...
                        try {
                          j = h(0) === '0' && h(new d()) === '0' && h(new g()) == '""' && h(n) === q && h(q) === q && h() === q && h(e) === '1' && h([e]) == '[1]' && h([q]) == '[null]' && h(null) == 'null' && h([q,
                          n,
                          ...
                          2], null, 1) == '[\n 1,\n 2\n]' && h(new i( - 8640000000000000)) == '"-271821-04-20T00:00:00.000Z"' && h(new i(8640000000000000)) == '"+275760-09-13T00:00:00.000Z"' && h(new i( - 62198755200000)) == '"-000001-01-01T00:00:00.000Z"' && h(new i( - 1)) == '"1969-12-31T23:59:59.999Z"'
                        } catch (a) {
                          j = !1
                        }
                      }
                      ...
                      if (typeof h == 'object' && h) {
                        ...
                        if (i == u && !o.call(h, 'toJSON')) if (h > - 1 / 0 && h < 1 / 0) {
                          if (C) {
                            ...
                            m = 1 + m - C(j, k);
                            r = (h % 86400000 + 86400000) % 86400000;
                            s = A(r / 3600000) % 24;
                            t = A(r / 60000) % 60;
                            z = A(r / 1000) % 60;
                            r = r % 1000
                          ...
                          h = (j <= 0 || j >= 10000 ? (j < 0 ? '-' : '+') + F(6, j < 0 ? - j : j)  : F(4, j)) + '-' + F(2, k + 1) + '-' + F(2, m) + 'T' + F(2, s) + ':' + F(2, t) + ':' + F(2, z) + '.' + F(3, r) + 'Z'
                        } else h = null;
        ...
        (function (a, b) {
          ...
          h = function () {
            ...
            a.prototype.set = function (a, b) {
              'use strict';
              var c = o(this, a);
              c != null && this._mapData[c] ? this._mapData[c][1] = b : (c = this._mapData.push([a,
              b]) - 1, p(this, a, c), this.size += 1);
              return this
            };
            ...
            function n(a, c) {
              ...
              if (ES([b,
              j,
              i], 'indexOf', !0, c) === - 1) throw new Error('Invalid iteration kind.');
              this._map = a;
              this._nextIndex = 0;
              this._kind = c
            }
          ...
          a.Map = h;
          a.Set = b
        }) (typeof global === 'undefined' ? this : global); __d('UrlMapConfig', [
        ], {
          ...
          'XdBundleUrl': '/connect/xd_arbiter/r/GMRn6XEBZ06.js?version=44',
          'useCdn': true
        }); __d('JSSDKCssConfig', [
        ], {
        ...
        __d('OAuthControllerParameterName', [
        ], (function (a, b, c, d, e, f) {
        ...
        __d('javascript_shared_TAAL_OpCode', [
        ], (function (a, b, c, d, e, f) {
          e.exports = ES('Object', 'freeze', !1, {
            PREVIOUS_FILE: 1,
            PREVIOUS_FRAME: 2,
        ...
        __d('eprintf', [
          ...
          function g(a) {
            ...
            if (f !== e.length) return g('eprintf args number mismatch: %s', ES('JSON', 'stringify', !1, [
              a
            ].concat(e)));
            var h = 0;
        ...
        __d('ex', [
          ...
          function h(a) {
            ...
            f = a.split('%s').length - 1;
            return f !== e.length ? h('ex args number mismatch: %s', ES('JSON', 'stringify', !1, [
              a
            ].concat(e)))  : h._prefix + ES('JSON', 'stringify', !1, [
              a
            ].concat(e)) + h._suffix
          }
          h._prefix = '<![EX[';
        ...
        __d('invariant', [
          ...
          function a(a, b) {
            ...
            if (!a) {
              ...
              var n = new Error(k.apply(void 0, [
                c
              ].concat(e)));
        ...
        __d('ManagedError', [
          ...
          function a(a, b) {
            'use strict';
            g.constructor.call(this, a !== null && a !== void 0 ? a : ''),
            a !== null && a !== void 0 ? this.message = a : this.message = '',
            this.innerError = b
          }
          e.exports = a
        }), null);
        ...
        __d('Assert', [
          ...
          'Regexp',
          'String',
          'Undefined'], 'forEach', !0, function (a) {
        ...
        __d('sdk.Impressions', [
          ...
          function o(a) {
            ...
            if (c.length > 2000 && (a.payload && typeof a.payload === 'string')) {
        ...
        __d('sdk.Scribe', [
          ...
          function a(a, b) {
            typeof b.extra === 'object' && (b.extra.revision = i.getRevision()),
            new Image().src = g.appendToUrl(h.resolve('www') + '/common/scribe_endpoint.php', {
              c: a,
        ...
        __d('URIBase', [
          ...
          function n(a, b, c, d) {
            ...
            if (e.userinfo !== null) if (c) throw new Error(i('URI.parse: invalid URI (userinfo is not allowed in a URI): %s', a.toString()));
             else return !1;
            if (!a.getDomain() && ES(a.getPath(), 'indexOf', !0, '\\') !== - 1) if (c) throw new Error(i('URI.parse: invalid URI (no domain but multiple back-slashes): %s', a.toString()));
             else return !1;
            if (!a.getProtocol() && m.test(b)) if (c) throw new Error(i('URI.parse: invalid URI (unsafe protocol-relative URLs): %s', a.toString()));
             else return !1;
            if (a.getDomain() && a.getPath() && !ES(a.getPath(), 'startsWith', !0, '/')) if (c) throw new Error(i('URI.parse: invalid URI (domain and path where path lacks leading slash): %s', a.toString()));
             else return !1;
            return !0
          }
          var o = [
        ...
        __d('Queue', [
          ...
          h.prototype._dispatch = function (a) {
            ...
            if (b != null) a.call(this, this._queue.shift()),
            this._timeout = setTimeout(ES(function () {
        ...
        __d('XDM', [
          ...
          a = {
            register: function (a, b) {
              g.debug('Registering %s as XDM provider', a),
              k.transports.push(a),
              j[a] = b
            },
            create: function (a) {
        ...
        __d('JSONRPC', [
          ...
          a.prototype.read = function (a, b) {
            ...
            try {
              ...
              g.error('Invokation of RPC method %s resulted in the error: %s', a.method, b.message),
              f('error', {
                code: - 32603,
        ...
        __d('DOMEventListener', [
          ...
          var l,
          m;
          window.addEventListener ? (l = function (a, b, c, d) {
            d === void 0 && (d = !1),
            c.wrapper = j(c, 'entry', g('DOMEventListener.add ' + b)),
            a.addEventListener(b, c.wrapper, k ? d : !1)
          }, m = function (a, b, c, d) {
            d === void 0 && (d = !1),
            a.removeEventListener(b, c.wrapper, k ? d : !1)
          })  : window.attachEvent ? (l = function (a, b, c, d) {
            d === void 0,
            c.wrapper = j(c, 'entry', 'DOMEventListener.add ' + b),
            a.attachEvent || i(0, 2798),
            a.attachEvent('on' + b, c.wrapper)
          }, m = function (a, b, c, d) {
            d === void 0,
            a.detachEvent || i(0, 2799),
        ...
        __d('sdk.XD', [
          ...
          function J(a) {
            ...
            t.setEnvironment(a === 'canvas' ? t.ENVIRONMENTS.CANVAS : t.ENVIRONMENTS.PAGETAB)
          }
          function K(a, b) {
            __p && __p();
            if (!b) {
            ...
            switch (a.xd_action) {
              case 'proxy_ready':
                ...
                c.start(function (a) {
                  a != null && typeof a === 'object' && (a = i.encode(a)),
                  D.send(a, b, d.contentWindow, B + '_' + z)
                });
                break;
              case 'plugin_ready':
          ...
          function M(a, b) {
            if (a == 'facebook') typeof b === 'object' && (b.relation = 'parent.parent'),
            w.enqueue(b);
             else {
              typeof b === 'object' && (b.relation = 'parent.frames["' + a + '"]');
              var c = H[a];
              c ? (h.debug('Enqueuing message for plugin %s in %s', a, c.protocol + 'ProxyQueue'), x.enqueue(b))  : (h.debug('Buffering message for plugin %s', a), j.get(a, {
              }).enqueue(b))
            }
          }
        ...
        __d('sdk.Auth', [
          ...
          function G(a, b, c) {
            ...
            return function (d) {
              ...
              if (d && d.access_token) {
                ...
                d.granted_scopes && (b = babelHelpers['extends']({
                }, b, {
                  grantedScopes: d.granted_scopes
                }));
                d.reauthorize_required_in && (b = babelHelpers['extends']({
                }, b, {
                  reauthorize_required_in: parseInt(d.reauthorize_required_in, 10)
                }));
                d.data_access_expiration_time && (b = babelHelpers['extends']({
                }, b, {
                ...
                if (s.getUseCookie()) {
                  f = b.expiresIn === 0 ? 0 : ES('Date', 'now', !1) + b.expiresIn * 1000;
                  var g = n.getDomain();
                ...
                g = 'connected';
                E(b, g)
              } else c === 'logout' || c === 'login_status' ? (d && d.error === 'not_authorized' ? (g = 'not_authorized', E(null, g))  : (g = 'unknown', E(null, g)), s.getUseCookie() && n.clearSignedRequestCookie(), s.getUseLocalStorage() && H(), c === 'logout' && (J(), t.log('jssdk_error', {
                appId: s.getClientID(),
          ...
          function a(a, b) {
            ...
            c = function (a) {
              L = 'loaded',
              D.inform('FB.loginStatus', a),
              D.clearSubscribers('FB.loginStatus')
            };
            K(c)
          }
        ...
        __d('sdk.DOM', [
          ...
          function n(a, b) {
            var c = !0;
            for (var d = 0, e; e = b[d++]; ) e in i || (c = !1, i[e] = !0);
            if (c) return;
        ...
        __d('ApiBatcher', [
          ...
          m.prepareBatchParams = function (a) {
            ...
            a.toLowerCase() == 'post' && (d = h.encode(b.getQueryData()), e = b.setQueryData({
            }).toString());
            return {
              body: d,
              callback: c,
        ...
        __d('CORSRequest', [
          ...
          function k(a, b) {
            ...
            f = j(function () {
              f = d,
              'onload' in e && e.onload(c)
            }, 'entry', 'XMLHttpRequest:load'),
            g = j(function () {
              g = d,
              'onerror' in e && e.onerror(c)
        ...
        __d('ApiClient', [
          ...
          function C(a, b, c, d) {
            ...
            h = f.access_token || r;
            h && (g.access_token = h);
            h = ES('Object', 'keys', !1, g);
            h.length > 0 && (a = o.appendToUrl(a, g), ES(h, 'forEach', !0, function (a) {
              return delete f[a]
            }));
            f.transport ? (g = [
              f.transport
            ], delete f.transport)  : g = w;
            for (var h = 0; h < g.length; h++) {
              var i = e[g[h]],
              m = ES('Object', 'assign', !1, {
              }, f);
              if (i.execute(a, b, m, d)) return
            }
            d({
              error: {
                type: 'no-transport',
          ...
          function E() {
            ...
            i = g.method;
            G(e, i) && (i = 'post');
            var j = e.getProtocol() && e.getDomain() ? e.setQueryData({
            }).toString()  : p.resolve('graph') + e.getPath(),
            k = A++;
        ...
        __d('AppUserPropertyAPIBuiltinField', [
        ], (function (a, b, c, d, e, f) {
          e.exports = {
            GENDER: '$gender',
            CITY: '$city',
        ...
        __d('sdk.AppEvents', [
          ...
          function a(a, b, c, d) {
            ...
            e[q.CURRENCY] = c;
            D(a, p.PURCHASED, b, babelHelpers['extends']({
            }, d, e))
          }
          function b(a) {
            D(a, p.ACTIVATED_APP)
          ...
          function G(a) {
            h.isTrue(a.length !== 0, 'User ID must be set before updateUserProperties can be called.'),
            h.isTrue(a.length <= v, 'Invalid user ID: ' + a + '. It must be no longer than ' + v + ' characters.')
          }
          function c(a) {
            G(a),
            A.setUserID(a)
          ...
          function L(a) {
            ...
            for (var b in a) h.isTrue(t.test(b) || ES(z, 'includes', !0, b), 'Invalid user properties key name: ' + b + '. It must be between 1 and ' + u + ' characters, and must contain only alphanumerics, _, - or spaces, starting with alphanumeric or _. Or, it must be a pre-defined user property'),
            h.isTrue(a[b].toString().length <= y, 'Invalid user properties value: ' + a[b] + '. It must be no longer than ' + y + ' characters.')
          }
          function M(a, b, c) {
            var d = H();
            G(d);
        ...
        __d('sdk.DialogUtils', [
          ...
          a = {
            ...
            addIdleDesktopAction: function (a, b, c) {
              ...
              f();
              return g.add(a, 'mouseenter', function () {
                clearTimeout(d),
                e || (e = g.add(a, 'mouseleave', function () {
                  f()
                }))
              })
            },
            addMobileOrientationChangeAction: function (a) {
              ...
              return g.add(window, b, c)
            },
            applyScreenDimensions: function (a) {
              if (a == null) return;
              var b = i.getViewportInfo();
            ...
            setDialogPositionToCenter: function (a, b, c) {
              ...
              if (j.mobile()) {
                c = 100;
                b ? (c += (e.height - d) / 2, i.addCss(document.body, 'fb_reposition'))  : (i.addCss(document.body, 'fb_hidden'), document.body.style.width = 'auto', k = 10000);
                g = i.getByClass('fb_dialog_padding', a);
            ...
            setupNewDialog: function (a) {
              ...
              a.content && h.append(a.content, c);
            ...
            onDialogHideCleanup: function (a) {
              var b = document.body;
              a ? i.removeCss(b, 'fb_reposition')  : i.removeCss(b, 'fb_hidden')
            }
          };
          e.exports = a
        }), null);
        ...
        __d('sdk.Dialog', [
          ...
          x = {
            ...
            _findRoot: function (a) {
              while (a) {
                if (m.containsCss(a, 'fb_dialog')) return a;
                a = a.parentNode
              }
            },
            ...
            _setDialogOverlayStyle: function () {
              l.applyScreenDimensions(x._overlayEl)
            },
            _showTabletOverlay: function (a) {
              if (!x.isTabletStyle()) return;
              x._overlayEl || (x._overlayEl = l.setupNewDarkOverlay(), k.append(x._overlayEl, null));
              if (x._closeOnOverlayTap) {
                a = l.addDoubleClickAction(x._overlayEl, ES(a, 'bind', !0, this), 5000);
            ...
            showLoader: function (a, b) {
              ...
              var c = function () {
                x._hideLoader(),
                l.onDialogHideCleanup(x.isTabletStyle()),
            ...
            _makeActive: function (a) {
              ...
              x._lowerActive(),
              x._active = a,
              o.isEnvironment(o.ENVIRONMENTS.CANVAS) && j.getPageInfo(function (a) {
                x._centerActive(a)
              }),
              x._centerActive()
            },
            ...
            _centerActive: function (a) {
              var b = x._active;
              if (!b) return;
              x._positionDialogAtTopWhenPortrait && l.isOrientationPotrait() ? l.setDialogPositionToTop(b, x.isTabletStyle(), a)  : l.setDialogPositionToCenter(b, x.isTabletStyle(), a)
            },
            ...
            getDefaultSize: function () {
              ...
              if (p.mobile()) {
                var a = v();
                if (a) {
                  m.getViewportInfo().width <= a.width && (a.width = m.getViewportInfo().width - q);
                  m.getViewportInfo().height <= a.height && (a.height = m.getViewportInfo().height - q);
                  return a
                }
                if (p.ipad()) return {
                  width: s,
            ...
            _handleOrientationChange: function () {
              __p && __p();
              x._availScreenWidth = m.getViewportInfo().width;
              if (x.isTabletStyle()) x._setDialogSizes(!0),
              x._centerActive(),
            ...
            _addOrientationHandler: function () {
              ...
              x._availScreenWidth = m.getViewportInfo().width;
              l.addMobileOrientationChangeAction(x._handleOrientationChange)
            },
            create: function (a) {
              var b = l.setupNewDialog(a);
              k.append(b.dialogElement);
            ...
            hide: function (a) {
              var b = x._findRoot(a);
              x._hideLoader();
              b == x._active && (x._lowerActive(), l.onDialogHideCleanup(x.isTabletStyle()), x._hideTabletOverlay(), 'fbCallID' in a && x.get(a.fbCallID).inform('iframe_hide').trackEvent('hide'))
            },
            remove: function (a) {
              a = x._findRoot(a);
              if (a) {
                var b = x._active == a;
                x._removeStacked(a);
                b ? (x._hideLoader(), x._stack.length > 0 ? x.show(x._stack.pop())  : (x._lowerActive(), l.onDialogHideCleanup(x.isTabletStyle()), x._hideTabletOverlay()))  : x._active === null && x._stack.length > 0 && x.show(x._stack.pop());
                setTimeout(function () {
          ...
          a = {
            onready: function (a) {
              ...
              if (this.nativeReady) a();
                ...
                var b = function b(c) {
                  window.removeEventListener(i, b),
                  this.onready(a)
                };
        ...
        __d('sdk.UIServer', [
          ...
          'sdk.UA',
          'sdk.XD'
        ], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E) {
          __p && __p();
          var F = {
          ...
          var M = {
            ...
            prepareCall: function (a, b) {
              ...
              d = Object.prototype.hasOwnProperty.call(M.Methods, c) ? ES('Object', 'assign', !1, {
              }, M.Methods[c])  : {
              },
              e = l(),
              f = !0;
              ...
              (c === 'share' || c === 'share_open_graph') && (a.mobile_iframe = D.mobile() && (a.mobile_iframe || a.iframe_test), a.mobile_iframe && (d = ES('Object', 'assign', !1, {
              }, F)));
            ...
            _popupMonitor: function () {
              __p && __p();
              var a;
              for (var b in M._loadedNodes) if (Object.prototype.hasOwnProperty.call(M._loadedNodes, b) && b in M._defaultCb) {
            ...
            _xdRecv: function (a, b) {
              ...
              } else r.containsCss(c, 'FB_UI_Hidden') ? setTimeout(function () {
                c.parentNode.parentNode.removeChild(c.parentNode)
              }, 3000)  : r.containsCss(c, 'FB_UI_Dialog') && q.remove(c);
        ...
        __d('legacy:fb.auth', [
          ...
          i.subscribe('authresponse.change', ES(k.fire, 'bind', !0, k, 'auth.authResponseChange')),
          i.subscribe('status.change', ES(k.fire, 'bind', !0, k, 'auth.statusChange')),
          k.subscribe('init:post', function (a) {
            __p && __p();
            a.status && i.getLoginStatus();
            if (l.getClientID() && l.getUseCookie()) {
        ...
        __d('sdk.Canvas.IframeHandling', [
          ...
          function a(a, b) {
            ...
            a || a === void 0 ? (i === null && (i = setInterval(function () {
              l()
        ...
        __d('legacy:fb.frictionless', [
          'FB',
          'sdk.Frictionless'
        ], (function (a, b, c, d, e, f, g, h) {
          g.provide('Frictionless', h)
        }), 3);
        __d('sdk.MBasicInitializer', [
          'UrlMap',
          'sdk.DOM',
          'sdk.fbt',
          'sdk.Runtime',
        ...
        __d('sdk.init', [
          ...
          function s(a) {
            ...
            if (o.getIsVersioned()) {
              ...
              if (a.authResponse) throw new h('Setting authResponse is not supported');
        ...
        __d('sdk.Time', [
          ...
          if (l) {
            ...
            if (b.length > 1) if (b > 2) b = null;
             else {
              c = ES(b, 'findIndex', !0, function (a) {
        ...
        __d('XFBML', [
          ...
          function t(a, b, c) {
            ...
            i = function () {
              e--,
              e === 0 && (h.info('XFBML Parsing Finish %s, %s tags found', d, f), b(), n.inform('render', d, f)),
              g.isTrue(e >= 0, 'onrender() has been called too many times')
            };
        ...
        __d('IframePlugin', [
          ...
          function B(a, b, c, d) {
            ES(ES('Object', 'keys', !1, a), 'forEach', !0, function (e) {
              a[e] == 'text' && !c[e] && (c[e] = b.textContent || b.innerText || '', b.setAttribute(e, c[e])),
              d[e] = z[a[e]](A(c, e))
            })
          }
          function C(a) {
          ...
          var E = j.extend({
            constructor: function (a, b, c, d) {
              ...
              this.subscribe('xd.resize.flow', ES(function (a) {
                ...
                x(this._iframeOptions.root, C(a.width), C(a.height)),
                this.updateLift(),
              ...
              this.subscribe('xd.refreshLoginStatus', ES(function () {
                n.removeLogoutState(),
                n.getLoginStatus(ES(this.inform, 'bind', !0, this, 'login.status'), !0)
              }, 'bind', !0, this));
              ...
              this._iframeOptions = {
                ...
                url: f + i.encode(g),
                name: h,
                width: this._config.mobile_fullsize && t.mobile() ? void 0 : g.width || 1000,
            ...
            process: function () {
              ...
              this._timeoutID = setTimeout(ES(function () {
                D(this._iframe),
                g.warn('%s:%s failed to resize in %ss', this._ns, this._tag, c)
              }, 'bind', !0, this), c * 1000);
        ...
        __d('sdk.XFBML.CommentsCount', [
          ...
          a = h.extend({
            constructor: function (a, b, c, d) {
              g.addCss(a, 'fb_comments_count_zero'),
              d.count = 1,
              this.parent(a, b, 'comments', d),
        ...
        __d('sdk.XFBML.CustomerChatWarning', [
          'Log'
        ], (function (a, b, c, d, e, f, g) {
          'use strict';
          function a(a, b, c, d) {
        ...
        __d('safeEval', [
          ...
          function a(a, b) {
            ...
            return /^\w+$/.test(a) && typeof window[a] === 'function' ? window[a].apply(null, b || [
            ])  : Function('return eval("' + a.replace(/\"/g, '\\"') + '");').apply(null, b || [
            ])
          }
          e.exports = a
        }), null);
        __d('sdk.XFBML.LoginButton', [
          'IframePlugin',
          'Log',
          'safeEval',
          'sdk.ErrorHandling',
        ...
        __d('sdk.XFBML.Quote', [
          ...
          function y(a) {
            ...
            if (b) {
              var c = !1;
              for (var d = 0; d < b; d++) if (j(t[d], a.focusNode)) {
                c = !0;
                break
              }
              if (!c) return
            ...
            i.strlen(r) > b ? r = i.substr(r, 0, b - 3) + '...' : r = i.substr(r, 0, b);
            if (!u && v) {
              x(a).appendChild(v);
              d = z(a);
              v.style.left = d.x + 'px';
          ...
          a = h.extend({
            constructor: function (a, b, c, d) {
              ...
              if (s) return s;
              this.parent(a, b, c, d);
              u = k.getAttr(a, 'layout') === 'button';
              v = a;
              v.style.position = 'absolute';
              v.style.display = '';
              g.add(document, 'keyup', y);
              g.add(document, 'mouseup', y);
              ...
              t = ES(ES('Array', 'from', !1, document.getElementsByTagName('*')), 'filter', !0, function (a) {
                return a.nodeName.toLowerCase() === 'article' || k.containsCss(a, o)
              });
              A();
              s = this;
              return s
        ...
        __d('sdk.XFBML.Save', [
          ...
          a = g.extend({
            constructor: function (a, b, c, d) {
              ...
              this.subscribe('xd.savePluginGetBlankIframe', ES(function (a) {
                ...
                this.subscribe('xd.savePluginShowIframe', ES(function () {
                  ...
                  !e && !j && (j = k.addIdleDesktopAction(c, h, 7000))
                }, 'bind', !0, this));
            ...
            positionOnScreen: function (a, b) {
              ...
              } else l.setStyle(a, 'position', 'fixed'),
          ...
          a = h.extend({
            constructor: function (a, b, c, d) {
              ...
              this.subscribe('xd.onVideoAPIReady', function (a) {
                ...
                this._sharedVideoCache = new l(ES('JSON', 'parse', !1, a.data)),
                this._videoController = new m(this._iframeOptions.name, this._sharedObservable, this._sharedVideoCache),
                j.fire('xfbml.ready', {
                  type: 'video',
                  id: d.id,
        ...
        __d('legacy:fb.xfbml.plugins', [
          ...
          ES(l.getSDKUrl(), 'indexOf', !0, 'customerchat') !== - 1 ? delete m.customerchat : m.customerchat = b('sdk.XFBML.CustomerChatWarning');
          var n = k('plugin_tags_blacklist', [
          ]);
          ES(ES('Object', 'keys', !1, i), 'forEach', !0, function (a) {
            if (ES(n, 'indexOf', !0, a) !== - 1) return;
            j.registerTag({
              xmlns: 'fb',
          ...
          ES(ES('Object', 'keys', !1, m), 'forEach', !0, function (a) {
            if (ES(n, 'indexOf', !0, a) !== - 1) return;
            j.registerTag({
              xmlns: 'fb',
              localName: a.replace(/_/g, '-'),
  ...
  new Image().src = 'https://www.facebook.com/' + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4738566","namespace":"FB","message":"' + e.message + '"}}');
}
